...
If TabNumber = 4 Then
  For i = 1 To frmmain.CoFonts.ListCount - 1
   If Not fMainForm.CoFonts.List(i) = "" Then CoFonts.AddItem frmmain.CoFonts.List(i)
  Next i
 CoFonts.ListIndex = 0
End If
'Tr
...
Select Case TabNumber
  ...
  For i = 1 To frmmain.CoFonts.ListCount - 1
   If Not frmmain.CoFonts.List(i) = "" Then CoFonts.AddItem frmmain.CoFonts.List(i)
  Next i
